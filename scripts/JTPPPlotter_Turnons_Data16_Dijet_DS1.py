...
## input files
#fin1 = TFile.Open("hist-Dijet_DS1/hist-Dijet_DS1.root")
fin1 = TFile.Open("hist-Dijet_DS1_wo360PTCut/hist-Dijet_DS1_wo360PTCut.root")
...
multiHistoList = ["HLT-singleJetTriggers-high"]
# -------------------------- TurnOns ----------------------------------
...
for multiHistoName in multiHistoList:
  ...
  for turnOn in turnOnList:
    ...
    if (multiHistoName == "HLT-singleJetTriggers-high"):
      if (turnOn == "HLT_j360-L1_J100"): print "using... " + turnOn
      elif (turnOn == "HLT_j380-L1_J100"): print "using... " + turnOn
      elif (turnOn == "HLT_j400-L1_J100"): print "using... " + turnOn
      else: continue
...
#      else: continue
    ...
    for EvalType in ["TDT"]: # ["Emu", "TDT"]:
      ...
      if (closer):
        ...
        if (multiHistoName == "HLT-singleJetTriggers-high"): histo1.GetXaxis().SetRangeUser(290.0, 550.0)
