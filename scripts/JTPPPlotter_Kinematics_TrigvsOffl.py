...
#fin = TFile.Open("hist-TLA-Test/hist-sample.root")
#fin = TFile.Open("hist-TLA/hist-TLA2015.root")

#wo Cuts
#fin = TFile.Open("hist-Data16_run298609/hist-Data16_run298609.root")
#fin = TFile.Open("hist-20160425_PeriodJ_282625_r7734_woCuts/hist-20160425_PeriodJ_282625_r7734.root")

#with 30GeV cuts
#fin1 = TFile.Open("hist-Data16_run298609_30GeVTrigJetCut/hist-Data16_run298609.root")
#fin2 = TFile.Open("hist-Data16_run298609_30GeVOfflJetCut/hist-Data16_run298609.root")

fin1 = TFile.Open("hist-20160425_PeriodJ_282625_r7734_30GeVTrigJetCut/hist-20160425_PeriodJ_282625_r7734.root")
fin2 = TFile.Open("hist-20160425_PeriodJ_282625_r7734_30GeVOfflJetCut/hist-20160425_PeriodJ_282625_r7734.root")


# label below ATLAS
## wo Cuts
#labelBelowATLAS = "Run 298609"
#labelBelowATLAS = "Period J Data"

## with Cuts
labelBelowATLAS = "Run 298609"
#labelBelowATLAS = "Period J Data"
labelBelowATLAS2 = "30 GeV cut"

## sample name in the legend
sampleName1 = "trigger jets"
sampleName2 = "offline jets"
